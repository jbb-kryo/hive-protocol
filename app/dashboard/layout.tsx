...
import { TosReacceptanceDialog } from '@/components/dashboard/tos-reacceptance-dialog'
...
export default function DashboardLayout({
  ...
  const { authChecked, emailVerified, isDemo, checkAuth, tosNeedsAcceptance, handleTosAccepted } = useAuth()
  ...
  return (
    <>
      ...
      {!isDemo && tosNeedsAcceptance && (
        <TosReacceptanceDialog
          open={tosNeedsAcceptance}
